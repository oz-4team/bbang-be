...
from app.content.models import Advertisement, Favorites, Likes, Notifications, authority
...
class AuthorityAdmin(admin.ModelAdmin):
    list_display = ("artistName", "artist_agency", "user", "phone_number", "image_url", "created_at")
    search_fields = ("artistName", "artist_agency", "user__email", "phone_number")
